...
from camera import camera, camera_close
import cv2
...
class CUi_MainWindow(QMainWindow, Ui_MainWindow): #继承于UI父类
    ...
    def detect():
        opt = CUi_MainWindow.parse_opt()
        check_requirements(exclude=('tensorboard', 'thop'))
        CUi_MainWindow.run(**vars(opt))
    ...
    def show_camera(a):
        show = cv2.cvtColor(a, cv2.COLOR_BGR2RGB)
